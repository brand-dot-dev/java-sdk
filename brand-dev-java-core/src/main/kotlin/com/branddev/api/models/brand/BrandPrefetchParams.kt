 ...
 * endpoint does not charge credits and is available for paid customers to optimize future requests.
 * [You must be on a paid plan to use this endpoint]
 */
class BrandPrefetchParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrandPrefetchParams].
         *
    ...
    /** A builder for [BrandPrefetchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandPrefetchParams: BrandPrefetchParams) = apply {
            body = brandPrefetchParams.body.toBuilder()
            additionalHeaders = brandPrefetchParams.additionalHeaders.toBuilder()
            additionalQueryParams = brandPrefetchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BrandPrefetchParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BrandPrefetchParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "BrandPrefetchParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
