 ...
 * addresses. This endpoint extracts the domain from the email address and returns brand data for
 * that domain. Disposable and free email addresses (like gmail.com, yahoo.com) will throw a 422
 * error.
 */
class BrandRetrieveByEmailParams
private constructor(
    ...
    /**
     * Email address to retrieve brand data for (e.g., 'contact@example.com'). The domain will be
     * extracted from the email. Free email providers (gmail.com, yahoo.com, etc.) and disposable
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrandRetrieveByEmailParams].
         *
    ...
    /** A builder for [BrandRetrieveByEmailParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandRetrieveByEmailParams: BrandRetrieveByEmailParams) = apply {
            email = brandRetrieveByEmailParams.email
            forceLanguage = brandRetrieveByEmailParams.forceLanguage
            maxSpeed = brandRetrieveByEmailParams.maxSpeed
            timeoutMs = brandRetrieveByEmailParams.timeoutMs
            additionalHeaders = brandRetrieveByEmailParams.additionalHeaders.toBuilder()
            additionalQueryParams = brandRetrieveByEmailParams.additionalQueryParams.toBuilder()
        }

        /**
         * Email address to retrieve brand data for (e.g., 'contact@example.com'). The domain will
         * be extracted from the email. Free email providers (gmail.com, yahoo.com, etc.) and
        ...
        /**
         * Returns an immutable instance of [BrandRetrieveByEmailParams].
         *
         ...
         */
        fun build(): BrandRetrieveByEmailParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrandRetrieveByEmailParams &&
            email == other.email &&
    ...
    override fun toString() =
        "BrandRetrieveByEmailParams{email=$email, forceLanguage=$forceLanguage, maxSpeed=$maxSpeed, timeoutMs=$timeoutMs, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
