...
dependencies {
    testImplementation(project(":brand-dev-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../brand-dev-java-core/src/main/resources/META-INF/proguard/brand-dev-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.branddev.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../brand-dev-java-core/src/main/resources/META-INF/proguard/brand-dev-java-core.pro",
