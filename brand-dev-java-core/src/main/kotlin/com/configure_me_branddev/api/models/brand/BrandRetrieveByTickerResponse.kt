...
import com.configure_me_branddev.api.core.checkKnown
import com.configure_me_branddev.api.core.toImmutable
...
class BrandRetrieveByTickerResponse
private constructor(
    ...
    /** A builder for [BrandRetrieveByTickerResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandRetrieveByTickerResponse: BrandRetrieveByTickerResponse) = apply {
            brand = brandRetrieveByTickerResponse.brand
            code = brandRetrieveByTickerResponse.code
            status = brandRetrieveByTickerResponse.status
            additionalProperties = brandRetrieveByTickerResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrandRetrieveByTickerResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrandRetrieveByTickerResponse =
            BrandRetrieveByTickerResponse(brand, code, status, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): BrandRetrieveByTickerResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "BrandRetrieveByTickerResponse{brand=$brand, code=$code, status=$status, additionalProperties=$additionalProperties}"
}
