...
class BrandPrefetchByEmailResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrandPrefetchByEmailResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrandPrefetchByEmailResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandPrefetchByEmailResponse: BrandPrefetchByEmailResponse) = apply {
            domain = brandPrefetchByEmailResponse.domain
            message = brandPrefetchByEmailResponse.message
            status = brandPrefetchByEmailResponse.status
            additionalProperties = brandPrefetchByEmailResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrandPrefetchByEmailResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrandPrefetchByEmailResponse =
    ...
    fun validate(): BrandPrefetchByEmailResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrandPrefetchByEmailResponse &&
            domain == other.domain &&
    ...
    override fun toString() =
        "BrandPrefetchByEmailResponse{domain=$domain, message=$message, status=$status, additionalProperties=$additionalProperties}"
}
