...
import com.branddev.api.client.okhttp.OkHttpClient
import com.branddev.api.core.RequestOptions
import com.branddev.api.core.Sleeper
import com.branddev.api.errors.BrandDevRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw BrandDevRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            BrandDevRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
