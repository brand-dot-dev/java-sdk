 ...
 * disposable or free email provider, and queues the domain for prefetching. This endpoint does not
 * charge credits and is available for paid customers to optimize future requests.
 * [You must be on a paid plan to use this endpoint]
 */
class BrandPrefetchByEmailParams
private constructor(
    ...
    /**
     * Email address to prefetch brand data for. The domain will be extracted from the email. Free
     * email providers (gmail.com, yahoo.com, etc.) and disposable email addresses are not allowed.
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrandPrefetchByEmailParams].
         *
    ...
    /** A builder for [BrandPrefetchByEmailParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandPrefetchByEmailParams: BrandPrefetchByEmailParams) = apply {
            body = brandPrefetchByEmailParams.body.toBuilder()
            additionalHeaders = brandPrefetchByEmailParams.additionalHeaders.toBuilder()
            additionalQueryParams = brandPrefetchByEmailParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Email address to prefetch brand data for. The domain will be extracted from the email.
         * Free email providers (gmail.com, yahoo.com, etc.) and disposable email addresses are not
         * allowed.
         */
        ...
        /**
         * Returns an immutable instance of [BrandPrefetchByEmailParams].
         *
         ...
         */
        fun build(): BrandPrefetchByEmailParams =
    ...
    private constructor(
        ...
        ) : this(email, timeoutMs, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("email", email), timeoutMs, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy { Objects.hash(email, timeoutMs, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{email=$email, timeoutMs=$timeoutMs, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrandPrefetchByEmailParams &&
            body == other.body &&
    ...
    override fun toString() =
        "BrandPrefetchByEmailParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
