...
class BrandRetrieveByIsinResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrandRetrieveByIsinResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrandRetrieveByIsinResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandRetrieveByIsinResponse: BrandRetrieveByIsinResponse) = apply {
            brand = brandRetrieveByIsinResponse.brand
            code = brandRetrieveByIsinResponse.code
            status = brandRetrieveByIsinResponse.status
            additionalProperties = brandRetrieveByIsinResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrandRetrieveByIsinResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrandRetrieveByIsinResponse =
            BrandRetrieveByIsinResponse(brand, code, status, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): BrandRetrieveByIsinResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrandRetrieveByIsinResponse &&
            brand == other.brand &&
            code == other.code &&
            status == other.status &&
            additionalProperties == other.additionalProperties
    ...
    override fun toString() =
        "BrandRetrieveByIsinResponse{brand=$brand, code=$code, status=$status, additionalProperties=$additionalProperties}"
}
