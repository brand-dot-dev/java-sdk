...
class BrandRetrieveByNameResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrandRetrieveByNameResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrandRetrieveByNameResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(brandRetrieveByNameResponse: BrandRetrieveByNameResponse) = apply {
            brand = brandRetrieveByNameResponse.brand
            code = brandRetrieveByNameResponse.code
            status = brandRetrieveByNameResponse.status
            additionalProperties = brandRetrieveByNameResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrandRetrieveByNameResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrandRetrieveByNameResponse =
            BrandRetrieveByNameResponse(brand, code, status, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): BrandRetrieveByNameResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrandRetrieveByNameResponse &&
            brand == other.brand &&
            code == other.code &&
            status == other.status &&
            additionalProperties == other.additionalProperties
    ...
    override fun toString() =
        "BrandRetrieveByNameResponse{brand=$brand, code=$code, status=$status, additionalProperties=$additionalProperties}"
}
