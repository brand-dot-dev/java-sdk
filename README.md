...
[![Maven Central](https://img.shields.io/maven-central/v/com.branddev.api/brand-dev-java)](https://central.sonatype.com/artifact/com.branddev.api/brand-dev-java/0.0.1-alpha.0)
[![javadoc](https://javadoc.io/badge2/com.branddev.api/brand-dev-java/0.0.1-alpha.0/javadoc.svg)](https://javadoc.io/doc/com.branddev.api/brand-dev-java/0.0.1-alpha.0)
...
Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.branddev.api/brand-dev-java/0.0.1-alpha.0).
...
```kotlin
implementation("com.branddev.api:brand-dev-java:0.0.1-alpha.0")
```
